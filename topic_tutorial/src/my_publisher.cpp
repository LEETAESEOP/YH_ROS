...
#include "topic_tutorial/my_msg.h" // my_msg 메세지 헤더파일
                                   // 빌드 후 자동 실행
...
{   // init = initialize(?) 시작한다는 의미.
    ...
    ros::Publisher my_pub = nh.advertise<topic_tutorial::my_msg>("my_topic", 100);  // 퍼블리셔가 큐 형태로 subscriber로 밀어넣음. 그 사이즈가 100임.
